'''
Class used to define the setup of the Random Agent. This agent plays random actions each round.
'''
...
class RandomAgent:
    def __init__(self):
        ...
        self.agent_type = None          # The agents type
    ...
    # Return this agents current occupied and unoccupied perches
